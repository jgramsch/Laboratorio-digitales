...
HD_PWD='C:/Users/LENOVO/Documents/GitHub/IEE2783/experiencias/Laboratorio-digitales/Exp_3/Programa/StopLight/StopLight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_queue.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source btn_queue.tcl -notrace
