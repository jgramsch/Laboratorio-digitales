...
synth_design -top btn_queue -part xc7a35tcpg236-2L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef btn_queue.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file btn_queue_utilization_synth.rpt -pb btn_queue_utilization_synth.pb"
